                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="quantitykg" placeholder="in kg's">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Quantity (required no.of bags per kg)</label>
                            <input type="text" class="form-control" name="quantityperkg" id="" placeholder="required no.of bags per kg">
                        </div>
                    </div>
                </div>
                <br>
